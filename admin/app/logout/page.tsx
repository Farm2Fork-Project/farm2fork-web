    ...
    <AdminPageShell title="Logout" description="Your local demo session has been cleared. Return to the login page when you want to enter the admin preview again.">
      <div className="card" style={{ maxWidth: 720, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
          <button className="sidebar-report-btn" onClick={() => router.push('/login')} style={{ minWidth: 180, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
            <RotateCcw size={16} />
            Back to Login
          </button>
          <a href="/dashboard" style={{ minWidth: 180, textAlign: 'center', padding: '12px 14px', borderRadius: 14, border: '1px solid var(--surface-strong)', textDecoration: 'none', color: 'var(--text-dark)', fontWeight: 700 }}>
            Open Dashboard
          </a>
        </div>
      </div>
